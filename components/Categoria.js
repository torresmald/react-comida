...
function Categoria({ categoria }) {
    ...
    return (
        <div className={`${categoriaActual?.id === id ? 'bg-amber-400' : '' } flex items-center gap-4 w-full border p-5 hover:bg-amber-400 rounded hover:cursor-pointer`} onClick={() => handleClickCategoriaActual(id)}>
